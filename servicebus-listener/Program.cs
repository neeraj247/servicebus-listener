...
namespace ConsoleApp3
{
    class Program
    {
        ...
        {
            string ServiceBusConnectionString = "Endpoint=sb://temp-bus-service.servicebus.windows.net/;SharedAccessKeyName=listen-key;SharedAccessKey=wKq6ktzzQrRNLpZPtv5IEwkJ6pw1bGa1hCONOLkFRfE=;";
            string TopicName = "topic-test";
            string SubscriptionName = "temp-sub";
